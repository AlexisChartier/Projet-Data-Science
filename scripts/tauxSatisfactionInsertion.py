...
df2018 = df_setup('data/extraction_finale_enquete_2018DS.xls')
...
print('2019 :')
# Charger les données depuis le fichier Excel
df2019 = df_setup('data/extraction_finale_enquete_2019DS.xlsx')
...
print('2021 :')
# Charger les données depuis le fichier Excel
df2021 = df_setup('data/extraction_finale_enquete_2021DS.xlsx')
